...
function fillCode( qual ){
    ...
    switch( qual ) {
        ...
        case 'eventos-result2':
            var text = '<xml xmlns="http://www.w3.org/1999/xhtml"><variables><variable type="" id="_?0h/R@.]?Zad(1%G4r_">numero</variable></variables><block type="procedures_defnoreturn" id="F2HwVw7**7cWmq6=W]=x" x="10" y="-130"><field name="NAME">iniciar</field><comment pinned="false" h="80" w="160">Teste de função</comment><statement name="STACK"><block type="text_print" id="E.=!0,Vwym]rN*q{cvCP"><value name="TEXT"><shadow type="text" id="=`Sko;OW2A7jIFFuj^gO"><field name="TEXT">Inicio</field></shadow><block type="text" id="c)bDjQCM@fXCQj^Qy|Hv"><field name="TEXT">Inicio</field></block></value></block></statement></block><block type="procedures_defnoreturn" id="(9O9ELQmU~?g~/jsu{Mi" x="10" y="-30"><mutation><arg name="numero" varid="_?0h/R@.]?Zad(1%G4r_"></arg></mutation><field name="NAME">botao</field><comment pinned="false" h="80" w="160">Descreva esta função...</comment><statement name="STACK"><block type="controls_if" id="w5.hv@Ee=Ng=G/9qXTe@"><mutation elseif="2" else="1"></mutation><value name="IF0"><block type="logic_compare" id="J=QGhBA,]k}r^ntW)S[W"><field name="OP">EQ</field><value name="A"><block type="variables_get" id="M72bVnEu[CS$PQI0(=Y8"><field name="VAR" id="_?0h/R@.]?Zad(1%G4r_" variabletype="">numero</field></block></value><value name="B"><block type="math_number" id="oCw?RdF`#O0MdgUdP/Fe"><field name="NUM">1</field></block></value></block></value><statement name="DO0"><block type="eng_lamp" id=")73%WDulIZXv5:moNejX"><field name="num">1</field><field name="estado">ON</field></block></statement><value name="IF1"><block type="logic_compare" id="Ykm7G-hKxL:zCZ*ij6{}"><field name="OP">EQ</field><value name="A"><block type="variables_get" id="]M=.3uH-~*$fYK2o+fRQ"><field name="VAR" id="_?0h/R@.]?Zad(1%G4r_" variabletype="">numero</field></block></value><value name="B"><block type="math_number" id="ivk8*(Lu4;}Sb{rHw%+i"><field name="NUM">2</field></block></value></block></value><statement name="DO1"><block type="eng_lamp" id="V[^y=x9h^`MY~j?[pD#{"><field name="num">1</field><field name="estado">OFF</field></block></statement><value name="IF2"><block type="logic_compare" id="5JvxF$G}}Fk0i[]QOvvk"><field name="OP">EQ</field><value name="A"><block type="variables_get" id="0Qn8n`YN#NU8R@`$jefL"><field name="VAR" id="_?0h/R@.]?Zad(1%G4r_" variabletype="">numero</field></block></value><value name="B"><block type="math_number" id="uDmg3Srm2Ef]f@$.*(?g"><field name="NUM">3</field></block></value></block></value><statement name="DO2"><block type="eng_lamp" id="-gmJO3K6RA!?D$u_QFm4"><field name="num">4</field><field name="estado">ON</field></block></statement><statement name="ELSE"><block type="eng_lamp" id="Tji-/mFKAFnb%@N:t(O."><field name="num">4</field><field name="estado">OFF</field></block></statement></block></statement></block></xml>';
            break;
